    ...
    <div className="App" style={{ textAlign: "center" }}>
      <header className="App-header">
        ...
        <div className="body-styling">
          With the both of them being brothers, cooks, and enjoyers of beer, one fateful day Steve and Al decided, why not try our hand at making our own? <br />
          ...
          In 2002, one year before I was born, they created their webpage, "Steve and Al's Brewhaus" to host what they had learned: <br />
          <div style={{fontSize: "16px", marginTop: "10px"}}><em><strong>"Now, a little background about
          ...
          We made all of these beers listed here plus many others not even on here yet. We've been brewing for some time now and love it. Happy Brewing!!!" </strong></em>~Steve and Al
          </div>
          </div>
        </div>
        <div className="body-styling" style={{maxWidth: "50%"}}>
          ...
          - like my uncle and father before me - enjoys beer, recreating this webpage seemed like the perfect project to learn about brewing and to commemorate their website. Enjoy!</div>
        </div>
      </header>
    </div>
  );
