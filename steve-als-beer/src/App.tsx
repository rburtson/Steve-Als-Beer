        ...
        <header className="App-header">
          ...
          <div className="grid-container">
            <div className="left-column">
                <Link to = "mash"><img src={mash} alt="mash" className="clickable" onMouseEnter={(e) => handleMouseEnter("mash", "left", e)} onMouseLeave={handleMouseLeave}/></Link>
                ...
                <Link to = "grains"><img src={grain} alt="grains" className="clickable" onMouseEnter={(e) => handleMouseEnter("grains", "left", e)} onMouseLeave={handleMouseLeave}/></Link>
                ...
                <Link to = "hops"><img src={hops} alt="hops" className="clickable" onMouseEnter={(e) => handleMouseEnter("hops", "left", e)} onMouseLeave={handleMouseLeave}/></Link>
                ...
                <Link to = "yeast"><img src={yeast} alt="yeast" className="clickable" onMouseEnter={(e) => handleMouseEnter("yeast", "left", e)} onMouseLeave={handleMouseLeave}/></Link>
            ...
            <div className="right-column">
                <Link to = "additives"><img src={add} alt="additives" className="clickable" onMouseEnter={(e) => handleMouseEnter("additives", "left", e)} onMouseLeave={handleMouseLeave}/></Link>
                ...
                <Link to = "recipes"><img src={recipe} alt="recipes" className="clickable" onMouseEnter={(e) => handleMouseEnter("recipes", "left", e)} onMouseLeave={handleMouseLeave}/></Link>
                ...
                <Link to = "styles"><img src={styles} alt="styles" className="clickable" onMouseEnter={(e) => handleMouseEnter("styles", "left", e)} onMouseLeave={handleMouseLeave}/></Link>
                ...
                <Link to = "glossary"><img src={glossary} alt="glossary" className="clickable" onMouseEnter={(e) => handleMouseEnter("glossary", "left", e)} onMouseLeave={handleMouseLeave}/></Link>
